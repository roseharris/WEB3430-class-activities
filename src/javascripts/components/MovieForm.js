    ...
    return(
        <form onSubmit={handleSubmit}>
            ...
            <div className="field">
                ...
                <div className="control">
                    <input type="number" name="year" max="2021" min="1900" value={values.year} onChange={handleChange}/>
            ...
            <div className="field">
                ...
                <div className="control">
                    <input type="number" name="votes" min="1" value={values.votes} onChange={handleChange}/>
